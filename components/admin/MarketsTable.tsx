    ...
    <div className="min-w-[104px]">
      <div className="flex items-center justify-between gap-2 font-mono text-xs tabular-nums">
        <span className="text-yes">
          {m.yes.price ? centsLabel(m.yes.price) : '—'}
        </span>
        <span className="text-no">
          {m.no.price ? centsLabel(m.no.price) : '—'}
        </span>
      </div>
      <div
        className="mt-1 flex h-[3px] w-full overflow-hidden bg-fg/10"
        aria-hidden="true"
      >
        {yes != null && (
          <>
      ...
      {Array.from({ length: 8 }).map((_, i) => (
        <tr key={i} className="border-t border-line/60">
          <td className="py-3 pr-3">
            <div
              className="h-3 animate-pulse bg-fg/10"
              style={{ width: `${55 + (i % 4) * 10}%` }}
            />
            <div className="mt-2 h-2 w-24 animate-pulse bg-fg/5" />
          </td>
          <td className="px-2">
            <div className="h-2.5 w-12 animate-pulse bg-fg/5" />
          </td>
          <td className="px-2">
            <div className="ml-auto h-2.5 w-20 animate-pulse bg-fg/5" />
          </td>
          <td className="px-2">
            <div className="ml-auto h-2.5 w-8 animate-pulse bg-fg/5" />
          </td>
          <td className="px-2">
            <div className="ml-auto h-2.5 w-12 animate-pulse bg-fg/5" />
          </td>
          <td className="pl-2">
            <div className="ml-auto h-2.5 w-10 animate-pulse bg-fg/5" />
          </td>
        </tr>
      ))}
    </>
  ...
  return (
    ...
    >
      <div className="mb-3 flex flex-wrap items-center gap-2.5">
        ...
        >
          <option
            style={{ backgroundColor: '#1E1919', color: '#fff' }}
            value=""
          >
            all resolvers
          </option>
